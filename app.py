...
@st.cache_data
def load_data():
    return pd.read_csv("C:/Users/Lenovo/Documents/Experiment/scraping/data/main_jpm_transcripts.csv")

df = load_data()

@st.cache_data
def load_sentiment_data():
    return pd.read_csv('C:/Users/Lenovo/Documents/Experiment/scraping/data/sentiment_analysis_jpm.csv')
